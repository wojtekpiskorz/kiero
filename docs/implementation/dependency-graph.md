...
| [[A1] Bootstrap the pinned core workspace and test commands](https://github.com/wojtekpiskorz/kiero/issues/16) | [[A0] Set up advisory PR review with thermo-nuclear and unslop](https://github.com/wojtekpiskorz/kiero/issues/65) | `package.json`, `package-lock.json`, `tsconfig*.json`, `.github/workflows/checks.yml`, `.gitignore`, `.env.example`, `apps/*/package.json`, `apps/*/tsconfig.json`, `packages/*/package.json`, `packages/*/tsconfig.json`, `apps/web/vite.config.ts`, `apps/web/src/bootstrap-placeholder.ts`, `apps/web/index.html`, `docs/handoffs/README.md`, `docs/handoffs/ux-ui/README.md`, `docs/handoffs/ux-ui/agent-start-prompt.md`, `docs/handoffs/ux-ui/feature-and-flow-inventory.md`, `docs/handoffs/ux-ui/product-brief.md`, `docs/handoffs/ux-ui/story-and-design-workflow.md`, `docs/implementation/README.md`, `docs/implementation/coordinator-start-prompt.md`, `docs/implementation/dependency-graph.md`, `docs/implementation/execution-charter.md`, `docs/implementation/issues.json`, `docs/implementation/proof-ownership.md`, `docs/implementation/ux-coverage.md`, `docs/mvp/ai-evaluation-plan.md`, `docs/mvp/alpha-readiness.md`, `docs/mvp/architecture-design.md`, `docs/mvp/architecture-proof-matrix.md`, `docs/mvp/decisions.md`, `docs/research/ai-training-consent-facts.md`, `docs/research/alpha-audio-cost-facts.md`, `docs/research/alpha-operations-facts.md`, `docs/research/alpha-services-runtime-facts.md`, `docs/research/architecture-backend-facts.md`, `docs/research/architecture-evidence-index.md`, `docs/research/architecture-typed-foundations.md`, `docs/research/auth-identity-facts.md`, `docs/research/backup-recovery-facts.md`, `docs/research/cloudflare-postgres-execution-facts.md`, `docs/research/convex-auth-integration-facts.md`, `docs/research/convex-cloudflare-fit.md`, `docs/research/effect-workflow-facts.md`, `docs/research/google-calendar-event-mapping-facts.md`, `docs/research/google-calendar-integration-facts.md`, `docs/research/google-calendar-reconnect-facts.md`, `docs/research/media-delivery-recovery-facts.md`, `docs/research/media-normalization-facts.md`, `docs/research/openrouter-integration-facts.md`, `docs/research/openrouter-model-routing-facts.md`, `docs/research/stt-embedding-release-facts.md` |
