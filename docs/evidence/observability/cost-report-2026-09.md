...
| --- | --- | --- |
| convex | unknown | BLOCKED: owner dashboard read |
| workers | unknown | BLOCKED: owner dashboard read |
| r2 | unknown | BLOCKED: owner dashboard read |
| containers | unknown | BLOCKED: owner dashboard read |
| images | unknown | BLOCKED: owner dashboard read |
| ai_openrouter | unknown | BLOCKED: owner dashboard read |
| ai_deepseek (direct) | unknown | BLOCKED: owner dashboard read |
| email_resend | unknown | BLOCKED: owner dashboard read |
| observability_axiom | unknown | BLOCKED: owner dashboard read |
