/**
 * Source acceptance command entries.
 *
 ...
 *   `unauthenticated` (there is no development-auth shortcut — sign-in provides the
 *   sign-in product that issues real identities).
 * - `acceptSourceTransaction` (internal mutation): the service-bridge path
 *   the platform proved (see platform/dispatch.ts `echoTransaction`): the caller
