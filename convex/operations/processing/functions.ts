/**
 * The processing-inspection Convex function surface (generated-call APIs).
 *
 ...
 * the seam (open grant + company + open alpha activation); every effect
 ...
 * command (the rule for GM surfaces). The barebones UI composes the
