/**
 * Notifications feature entry: the Polish barebones settings screen
 * for web push ("The Polish barebones settings screen shows
 ...
 * this entry is the host-composition edit: one import + one
