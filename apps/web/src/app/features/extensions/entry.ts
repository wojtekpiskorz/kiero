/**
 * Extensions feature entry (a host wiring point).
 * addition).
 *
 * "Dodatkowe informacje" is the typed-extension surface: the catalog
...
export const extensionsFeatureEntry = appFeatureEntry({
  ...
  consumedOperations: [
    ...
    // conversation rides), so the surface consumes the send pair too.
