...
export const accountCopy = {
  ...
  sessionCurrentDevice: "To urządzenie",
  sessionActive: "Aktywne",
  sessionRevoked: "Unieważnione",
  sessionUpstreamGone: "Sesja zamknięta",
  sessionUpstreamExpired: "Sesja wygasła",
  sessionUpstreamInactive: "Wygasła po 30 dniach nieaktywności",
  sessionLastSeenLabel: "ostatnia aktywność",
