/**
 * The Convex uploads-channel bridge client: how the Worker's upload
 ...
 * forwarded verbatim — Convex verifies the user's credential, the
 * live-session resolution and the canonical chain decide the acting user,
